 ...
 */
public class ThreadScopeProxy implements InvocationHandler {
    ...
    public <T> ThreadScopeProxy(ThreadLocal<Map<Class<?>, Object>> threadLocalinstances, Class<? extends T> clazz, InjectorImpl injector) {
