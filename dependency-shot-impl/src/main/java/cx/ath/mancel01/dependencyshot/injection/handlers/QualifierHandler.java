 ...
 */
public class QualifierHandler implements AnnotationHandler {

    /**
     * The unique instance of the class
     **/
    private static QualifierHandler INSTANCE = null;

    /**
     * The private constructor of the singleton
     **/
    private QualifierHandler() {
     ...
     **/
    public static synchronized QualifierHandler getInstance() {
        if ( INSTANCE == null ) {
            INSTANCE = new QualifierHandler();
        }
        return INSTANCE;
    }
}
